...
let load_mnist_train_data () =
  ...
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "mnist-train-images"),
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "mnist-train-labels"),
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "mnist-train-lblvec")

let load_mnist_test_data () =
  let p = local_data_path () in
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "mnist-test-images"),
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "mnist-test-labels"),
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "mnist-test-lblvec")
...
let load_mnist_train_data_arr () =
  ...
  let m = Owl_base_dense_ndarray_s.row_num x in
...
let load_cifar_train_data batch =
  let p = local_data_path () in
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "cifar10_train" ^ (string_of_int batch) ^ "_data"),
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "cifar10_train" ^ (string_of_int batch) ^ "_labels"),
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "cifar10_train" ^ (string_of_int batch) ^ "_lblvec")

let load_cifar_test_data () =
  let p = local_data_path () in
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "cifar10_test_data"),
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "cifar10_test_labels"),
  Owl_base_dense_ndarray_generic.load Float32 (p ^ "cifar10_test_lblvec")
...
let draw_samples_cifar x y n =
  ...
  Owl_base_dense_ndarray_generic.get_slice [a] x,
  Owl_base_dense_ndarray_generic.get_slice [a] y
